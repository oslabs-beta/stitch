...
var dataController = {
    getOne: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var request, data, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch('https://swapi.dev/api/people/1/')];
                case 1:
                    request = _b.sent();
    ...
    getUrlResponse: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var url, request, data, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    url = req.body.url;
