...
export default function EndpointComponent() {
  ...
  return (
    <div>
      <input className='EndpointComponent' type='text' onChange={handleChange} placeholder={inputText} />
      <button onClick={() => dispatch(addDataCard(inputText))} name='submit'>Add</button>
